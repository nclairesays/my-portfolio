...
class About extends Component {
  render() {
    return (
      <Slide slideID={"About"} slideTitle={`About Me!`}>
        <>
          <div className={"aboutMeDetails"}>
            <p>
              ...
              Developer for Hack for LA. I'm an active member and volunteer in
              the LA community.
              <br />
              <br />
            ...
            <h4>Some Technical Skills</h4> I am language agnostic and always
            open to learning new tech! But here is a quick snapshot of the tech
            I've worked with.
            <ul>
            ...
            <p>
              ...
              Policy, Planning and Development with an emphasis in Policy and
              Law. (Fight On, Trojans!) I've always loved helping people and
              giving back to my community and thought government was the way I
              wanted to do that. However, I always ended up gravitating towards
              tech over the years. I would love to be able to live and work
              knowing that my contributions in tech have a positive social and
              environmental impact on this world.
            </p>
            <p>
